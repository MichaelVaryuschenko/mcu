...
api_t device_api[] =
{
	...
	{"get_adc", get_adc_callback, "read voltage from ADC input"},
	{"get_temp", get_temp_callback, "read temperature from internal temperature sensor"},
    {"tm_start", tm_start_callback, "begin reading and sending telemetery"},
    {"tm_stop", tm_stop_callback, "cease reading and sending telemetery"},
    {NULL, NULL, NULL},
};
